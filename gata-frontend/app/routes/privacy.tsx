...
export default function Privacy() {
   return (
      <PageLayout>
         ...
         <Text>Last updated: April 14, 2022</Text>
         <Text>
         ...
         <Text mb={4}>We use both Session and Persistent Cookies for the purposes set out below:</Text>
         <ul>
            <li>
               <Text>
         ...
         <Heading as="h4">Business Transactions</Heading>
         <Text mb={4}>
